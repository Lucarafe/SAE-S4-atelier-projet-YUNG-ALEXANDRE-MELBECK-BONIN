...
INSERT INTO `article` (`titre`, `resume`, `contenu`, `img`, `auteur`, `idCategorie`, `created_at`, `updated_at`, `idAuteur`, `publication`) VALUES
                                                                                                                     ...
                                                                                                                     ('Les meilleures pratiques de rédaction en markdown', 'Découvrez comment rédiger du contenu en utilisant la syntaxe markdown.', 'Le markdown est un langage simple et efficace pour la rédaction de contenu. Apprenez les astuces et les bonnes pratiques pour l utiliser au mieux.', 'image2.jpg', 'jane.smith', 2, NOW(), NOW(),1, 1),
                                                                                                                     ('Nouvelle fonctionnalité de MiniPress', 'Découvrez la dernière fonctionnalité ajoutée à MiniPress.', 'Nous sommes heureux d annoncer une nouvelle fonctionnalité passionnante ajoutée à MiniPress. Elle facilitera encore plus la gestion de votre contenu.', 'image3.jpg', 'alice', 1, NOW(), NOW(), 4, 1),
                                                                                                                     ('Les avantages de lutilisation de MiniPress', 'Découvrez pourquoi MiniPress est le meilleur choix pour votre site web.', 'MiniPress offre de nombreux avantages, tels que la facilité d utilisation, la flexibilité et la puissance. Découvrez pourquoi de plus en plus de personnes choisissent MiniPress.', 'image4.jpg', 'bob', 3, NOW(), NOW(), 3, 1),
