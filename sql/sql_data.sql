...
INSERT INTO `article` (`titre`, `resume`, `contenu`, `img`, `auteur`, `idCategorie`, `created_at`, `updated_at`, `idAuteur`, `publication`) VALUES
                                                                                                                     ...
                                                                                                                     ('Nouvelle fonctionnalité de MiniPress', 'Découvrez la dernière fonctionnalité ajoutée à MiniPress.', 'Nous sommes heureux d annoncer une nouvelle fonctionnalité passionnante ajoutée à MiniPress. Elle facilitera encore plus la gestion de votre contenu.', 'image3.jpg', 'Alice Brown', 1, NOW(), NOW(), 4, 1),
